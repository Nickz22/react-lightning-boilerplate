...
// ReactDOM.render(<SequenceBuilder />, document.getElementById('body'));
_reactDom2.default.render(_react2.default.createElement(_LinkedIn2.default, null), document.getElementById('body'));
// import SequenceBuilder from './SequenceBuilder/SequenceBuilder';
...
function LinkedIn() {
    (0, _Util.log)('linkedin !!!');

    var _useState = (0, _react.useState)(["test name"]),
    ...
    return _react2.default.createElement(
        'div',
        { style: { position: "absolute", top: "30%", left: "30%", cursor: "pointer" }, onClick: function onClick() {
                return (0, _Util.doApexAction)('LinkedlnoAuthController.doGetAuthorizationCode', {}, function (results) {
